class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        Step 2:
        queue = [1]
        - 0 gets popped since nums[0] is smaller than nums[1], 1 gets pushed
        - nothing added, right += 1

        Step 3:
        queue = [1, 2]
        sol = [2]
        - nothing to pop, push 2 since it's smaller
        - add 2, the leftmost element's value to solution
        - left += 1, right += 1
        ...
        queue = [4]
        sol = [2, 2, 4]
        - pop 1, 2, 3 since vals are all smaller than 4
        ...
        queue = [6]
        sol = [2, 2, 4, 4, 6]
        - 4 and 5 get popped, since smaller than 6
        - 6 gets added to sol
        """